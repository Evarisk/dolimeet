...
/**
 * \file    test/phpunit/DoliMeetFunctionalTest.php
 * \ingroup dolimeet
 ...
 *
 * @package Testdolimeet
 */
class DoliMeetFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/dolimeet/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolimeet/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolimeet/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolimeet/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolimeetwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliMeet_DoliMeetTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliMeet_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
