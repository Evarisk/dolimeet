...
/**
 * \file    test/phpunit/DoliopiFunctionalTest.php
 * \ingroup doliopi
 ...
 * @package Testdoliopi
 */
class DoliopiFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/doliopi/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('doliopi/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/doliopi/admin/about.php');
		$this->authenticate();
		return $this->assertContains('doliopi/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('doliopiwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliopi_DoliopiTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliopi_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
