...
/**
 *  \file       meeting_note.php
 *  \ingroup    meeting
 *  \brief      Tab for notes on Meeting
 */
...
$hookmanager->initHooks(array('meetingnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Meeting'), $help_url);
