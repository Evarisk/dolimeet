...
ALTER TABLE llx_categorie_session ADD CONSTRAINT fk_categorie_session_doliopi_session_rowid FOREIGN KEY (fk_session) REFERENCES llx_doliopi_session (rowid);
