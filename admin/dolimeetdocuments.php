...
/**
 * \file    admin/dolimeetdocuments.php
 * \ingroup dolimeet
 * \brief   DoliMeet dolimeetdocuments page.
 */
...
print load_fiche_titre($title, $selectorAnchor, 'dolimeet_color.png@dolimeet');
...
foreach ($types as $type => $documentData) {
	...
	$dir = dol_buildpath('/custom/dolimeet/core/modules/dolimeet/dolimeetdocuments/' . $documentParentType . '/');
	if (is_dir($dir)) {
		$handle = opendir($dir);
