...
/**
 *	\file       core/modules/dolimeet/dolimeetdocuments/trainingsessiondocument/doc_attendancesheet_odt.modules.php
 *	\ingroup    dolimeet
 ...
 */
class doc_attendancesheet_odt extends ModeleODTTrainingSessionDocument
{
	/**
	 * Issuer
	 * @var Societe
	...
	public function write_file(SessionDocument $objectDocument, Translate $outputlangs, string $srctemplatepath, int $hidedetails = 0, int $hidedesc = 0, int $hideref = 0, Session $object): int
    {
        ...
        $refModName          = new $conf->global->DOLIMEET_TRAININGSESSIONDOCUMENT_ATTENDANCESHEETDOCUMENT_ADDON($this->db);
