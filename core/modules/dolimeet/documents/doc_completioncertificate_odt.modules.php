...
/**
 *	\file       core/modules/dolimeet/completioncertificate/doc_completioncertificate_odt.modules.php
 *	\ingroup    dolimeet
 ...
 */
class doc_completioncertificate_odt extends ModelePDFSession
{
	/**
	 * Issuer
	 * @var Societe
	...
	public function write_file($objectDocument, $outputlangs, $srctemplatepath, $hidedetails = 0, $hidedesc = 0, $hideref = 0, $object)
	{
		...
		{
			dol_syslog("doc_completioncertificate_odt::write_file parameter srctemplatepath empty", LOG_WARNING);
			return -1;
		}
		...
		if (file_exists($dir))
		{
			$filename = preg_split('/completioncertificate\//' , $srctemplatepath);
