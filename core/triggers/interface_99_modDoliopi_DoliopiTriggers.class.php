...
/**
 * \file    core/triggers/interface_99_modDoliopi_DoliopiTriggers.class.php
 * \ingroup doliopi
 * \brief   Doliopi trigger.
 */
...
/**
 * Class of triggers for Doliopi module.
 */
class InterfaceDoliopiTriggers extends DolibarrTriggers
{
    /**
    ...
    public function __construct(DoliDB $db)
    {
        ...
        $this->family      = 'demo';
        $this->description = 'Doliopi triggers.';
        $this->version     = '23.0.0';
        $this->picto       = 'doliopi@doliopi';
    }
    ...
    public function runTrigger($action, $object, User $user, Translate $langs, Conf $conf): int
    {
        ...
        if (getDolGlobalInt('DOLIOPI_ADVANCED_TRIGGER') === 1 &&
        ...
        switch ($action) {
            case 'TRAININGSESSION_CREATE' :
                ...
                $signatory = new SaturneSignature($this->db, 'doliopi', 'trainingsession');
