...
//	$head[$h][0] = dol_buildpath("/dolimeet/view/trainingsession/trainingSession_signature.php", 1) . '?id=' . $object->id;
//	$head[$h][1] = '<i class="fas fa-file-signature"></i> ' . $langs->trans("Sign");
//	$head[$h][2] = 'trainingSessionSign';
//	$h++;
...
//	$head[$h][0] = dol_buildpath("/dolimeet/view/trainingsession/trainingSession_contact.php", 1).'?id='.$object->id;
//	$head[$h][1] = $langs->trans("ContactsAddresses");
//	$head[$h][2] = 'trainingSessionContact';
//	$h++;

//	//Sending archive selection
//	$head[$h][0] = dol_buildpath("/dolimeet/view/trainingsession/trainingSession_sending.php", 1).'?id='.$object->id;
