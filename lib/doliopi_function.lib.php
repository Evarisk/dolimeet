...
/**
 * \file    lib/doliopi_function.lib.php
 * \ingroup doliopi
 * \brief   Library files with common functions for Doliopi
 */
...
function set_satisfaction_survey(CommonObject $object, string $contactCode, int $contactID, string $contactSource)
{
    ...
    $confName                  = 'DOLIOPI_' . dol_strtoupper($contactCode) . '_SATISFACTION_SURVEY_SHEET';
...
function get_formation_service(): array
{
    return [
        [
            'position' => 1,
            'code'     => 'DOLIOPI_SERVICE_TRAINING_CONTRACT',
            'ref'      => 'FOR_ADM_CF1',
            'name'     => 'TrainingContract'
        ],
        [
            'position' => 30,
            'code'     => 'DOLIOPI_SERVICE_PRACTICAL_GUIDE',
            'ref'      => 'FOR_ADM_GP1',
            'name'     => 'PracticalGuide'
        ],
        [
            'position' => 40,
            'code'     => 'DOLIOPI_SERVICE_WELCOME_BOOKLET',
            'ref'      => 'FOR_ADM_LA1',
            'name'     => 'WelcomeBooklet'
        ],
        [
            'position' => 50,
            'code'     => 'DOLIOPI_SERVICE_RULES_OF_PROCEDURE',
            'ref'      => 'FOR_ADM_RI1',
