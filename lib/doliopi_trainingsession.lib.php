...
/**
 * \file    lib/doliopi_trainingsession.lib.php
 * \ingroup doliopi
...
function trainingsession_function_lib1()
{
    ...
    $mainCategory      = getDolGlobalInt('DOLIOPI_FORMATION_MAIN_CATEGORY');
    $templateProjectId = getDolGlobalInt('DOLIOPI_TRAININGSESSION_TEMPLATES_PROJECT');
    ...
    $filterMain = [
        'customsql' =>
            ...
            ' AND rowid IN (
                ...
                FROM ' . MAIN_DB_PREFIX . 'doliopi_session ds
...
function trainingsession_function_lib2()
{
    ...
    $variousCategory = getDolGlobalInt('DOLIOPI_FORMATION_VARIOUS_MAIN_CATEGORY');
