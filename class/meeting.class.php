 ...
 * Class for Meeting
 */
class Meeting extends CommonObject
{
	/**
	 ...
	 */
	public $table_element = 'dolimeet_meeting';
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1) {
		...
		$label = img_picto('', $this->picto).' <u>'.$langs->trans("Meeting").'</u>';
		...
		$url = dol_buildpath('/dolimeet/meeting_card.php', 1).'?id='.$this->id;
	...
	{
		return parent::setCategoriesCommon($categories, 'meeting');
	}
